...
interface ProductColor { name: string; value: string; image: string }
interface ProductSize { size: string; available: boolean }
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Header */}
              <div>
                <p className="text-[var(--neon-green)] font-semibold mb-2">{product.brand}</p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-4">
                  Color: <span className="text-[var(--neon-green)]">{product.colors[selectedColor].name}</span>
                </h3>
            ...
            <div className="border-b border-gray-800 mb-8">
              <div className="flex gap-8">
                {['description', 'features', 'reviews'].map((tab) => (
                  <button
                    key={tab}
                    onClick={() => setActiveTab(tab as 'description' | 'features' | 'reviews')}
